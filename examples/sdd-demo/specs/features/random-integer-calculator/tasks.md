...
- [x] **T1** Implementar generación de enteros aleatorios en rango 2..200 en el servicio. (AC1)  
...
- [x] **T2** Implementar cálculo de la suma en el mismo servicio. (AC2)  
  - Archivo: `src/features/random-integer-calculator/random-integer-calculator.service.ts`.  
...
- [x] **T3** Implementar formato de salida en una sola línea `<a> + <b> = <c>`. (AC3)  
...
- [x] **T4** Exponer la feature desde el entrypoint. (AC3)  
...
- [x] **T5** Tests unitarios de la lógica (generación en rango, suma correcta). (AC1, AC2)  
...
- [x] **T6** Tests de integración del flujo completo. (AC3)  
...
- [x] **T7** Actualizar traceability en spec y acceptance. (AC4)  
