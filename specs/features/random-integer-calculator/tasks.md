...
- [ ] **T1** Implementar generación de enteros aleatorios en rango 2..200 en el servicio.  
...
- [ ] **T2** Implementar cálculo de la suma en el mismo servicio.  
  - Archivo: `src/features/random-integer-calculator/random-integer-calculator.service.ts`.  
...
- [ ] **T3** Implementar formato de salida en una sola línea `<a> + <b> = <c>`.  
...
- [ ] **T4** Exponer la feature desde el entrypoint.  
...
- [ ] **T5** Tests unitarios de la lógica (generación en rango, suma correcta).  
...
- [ ] **T6** Tests de integración del flujo completo.  
...
- [ ] **T7** Actualizar traceability en spec y acceptance.  
