---
description: Bootstrap a new feature in specs/features/<feature>/ with initial feature.spec.md, tasks.md, and acceptance.md skeletons. Specs-only — must not touch src/, tests/, package.json, lockfiles, or shared types. Use when starting a brand new SDD feature from a problem statement.
---
